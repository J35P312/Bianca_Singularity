...
%post
    ...
    conda install -c bioconda samtools sambamba minimap2 biobambam bedtools
    conda install -c bioconda lumpy-sv mummer4 bwa picard abyss gatk4 vt bcftools tabix
